...
import { getAllSongs, getMostListenedSongs, getSongById, getAllSongGenres, getAllSongsByGenre } from '../controllers/songs.controllers';

const songsRouter = express.Router();

songsRouter.get('/', getAllSongs);
songsRouter.get('/genres', getAllSongGenres);
songsRouter.get('/most-listened', getMostListenedSongs);
